...
const AnimatedSparkle: React.FC<SparkleProps> = ({ color = '#000000', size = 30, className, animate = true }) => {
  const mergedClasses = twMerge(className);
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      viewBox="-66.56 -66.56 645.12 645.12"
      id="icons"
