        ...
        <MaxWidthWrapper className='py-2  '>
            <nav className='h-10 flex items-center justify-between bg-opacity-60 px-4 py-2'>
                ...
                <div className='flex gap-2'>
                    <Link className={"flex items-center gap-2 bg-opacity-40 border bg-neutral-900 h-[37px] border-neutral-700 text-neutral-200  px-3 rounded-md "} href={"https://github.com/abhinav7895/interviewgenie"}> Star on <FaGithub className='text-lg' />  </Link>
