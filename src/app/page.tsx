...
export default function Home() {
  return (
    <>
    <Navbar />
    <MaxWidthWrapper className="pt-20 px-0">
      ...
      <div className="text-center mt-5 px-2.5 sm:mt-10 max-w-3xl mx-auto">
        ...
        <div className={" grid mt-10  grid-cols-12 w-full gap-2 " + quicksand.className}>
          <div className=" hover:rotate-1 transition-all rounded-md gap-2 bg-opacity-50 bg-neutral-950 border font-normal flex flex-col items-center border-neutral-800 hover:border-neutral-600 p-6 col-span-12 md:col-span-4 ">
          ...
          <div className=" hover:-rotate-1 transition-all  rounded-md gap-2 bg-opacity-50 bg-neutral-950 border font-normal flex flex-col items-center border-neutral-800 p-6 col-span-12 md:col-span-4 hover:border-neutral-600">
        ...
        <div className="mt-[100px] space-y-16">
